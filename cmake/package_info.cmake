...
function(callback_start)
	if(NOT CMAKE_SYSTEM_NAME STREQUAL "Android")
		...
		if(IS_DIRECTORY ${JUGIMAP_FRAMEWORK_SRC})
			...
			file(COPY ${JUGIMAP_FRAMEWORK_SRC}/examples_c++/SpriteTimelineAnimation/jugiApp DESTINATION ${JUGIMAP_FRAMEWORK_DEST})
			file(COPY ${JUGIMAP_FRAMEWORK_SRC}/examples_c++/SpriteTimelineAnimation/SpriteTimelineAnimation_nCine/ DESTINATION ${JUGIMAP_FRAMEWORK_DEST})
		endif()
	endif()
endfunction()
...
function(callback_before_target)
	if(NOT CMAKE_SYSTEM_NAME STREQUAL "Android" AND IS_DIRECTORY ${PACKAGE_DATA_DIR})
		set(JUGIMAP_FRAMEWORK_SRC "${CMAKE_BINARY_DIR}/jugimap_framework-src")
		if(IS_DIRECTORY ${JUGIMAP_FRAMEWORK_SRC})
			file(COPY ${JUGIMAP_FRAMEWORK_SRC}/examples_c++/SpriteTimelineAnimation/media/fonts DESTINATION ${PACKAGE_DATA_DIR}/data/media)
			file(COPY ${JUGIMAP_FRAMEWORK_SRC}/examples_c++/SpriteTimelineAnimation/media/graphics DESTINATION ${PACKAGE_DATA_DIR}/data/media)
			file(COPY ${JUGIMAP_FRAMEWORK_SRC}/examples_c++/SpriteTimelineAnimation/media/maps DESTINATION ${PACKAGE_DATA_DIR}/data/media)
		endif()
